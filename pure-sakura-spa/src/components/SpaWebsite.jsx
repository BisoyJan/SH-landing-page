        ...
        <div className="grid max-w-6xl grid-cols-1 gap-8 mx-auto md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>Unit 1439, 14 th Flr , Centuria Medical Makati , Century City Brgy. Poblacion, Kalayaan
			  Avenue, Makati City.</li>
              <li>OPERATING HOURS: 3:00 PM - 12:00 MIDNIGHT
			  Walk-In and Home Service Available</li>
            </ul>
          </div>
          <div>
